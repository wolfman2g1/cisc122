...
public class CreditCard {
	...
	/*
	 * add to the balance every time something is charged only if the balance is not
	 * greater than the credit limit
	 * 
	 */
	public void charge(Money amount) {
		if ((balance.getDollars() + amount.getDollars())
				+ (balance.getCents() + amount.getCents()) >= (creditLimit.getDollars() + creditLimit.getCents())) {
